...
class TencentMapController {
  TencentMapController._(this._tencentMapState, {required this.mapId}) {
  ...
  static TencentMapController init(int id, TencentMapState tencentMapState) {
    TencentMapMethodChannel.instance.init(id);
    return TencentMapController._(tencentMapState, mapId: id);
  }
      ...
      TencentMapMethodChannel.instance
          ...
          .listen(
            (MarkerDragStartEvent e) =>
                _tencentMapState.widget.onMarkerDragStart!(
                  e.value,
                  e.position.latLng,
                ),
          );
  ...
  void addMarker(Marker marker) {
    TencentMapMethodChannel.instance.addMarker(marker, mapId: mapId);
  }

  /// 移除标记点
  void removeMarker(String markerId) {
    TencentMapMethodChannel.instance.removeMarker(markerId, mapId: mapId);
  }
  ...
  void addPolyline(Polyline polyline) {
    TencentMapMethodChannel.instance.addPolyline(polyline, mapId: mapId);
  }

  /// 移除折线
  void removePolyline(String id) {
    TencentMapMethodChannel.instance.removePolyline(id, mapId: mapId);
  }

  /// 更新折线
  void updatePolyline(String id, PolylineUpdateOptions options) {
    TencentMapMethodChannel.instance.updatePolyline(id, options, mapId: mapId);
  }
